...
namespace MtEmbTest
{
    public partial class FrmMainMonitor : Form
    {
        ...
        private Stopwatch Canstopwatch = new Stopwatch();
        private DateTime CaninitialDateTime = DateTime.Now;
        private long CaninitialTimestamp = 0;
        private DateTime CanLastRecv = DateTime.Now;
        //CAN卡记录处理计时
      ...
      //  private  List<TimerState> EmbControlTimers = new List<TimerState>(1);
        ...
        private void RecvCanFdData(ZCAN_ReceiveFD_Data[] data, uint len, int HandleIndex)
        {
            ...
            if (!IsAutoLearn && IsRunning)   //正常接收
            {

                long currentTimestamp = Canstopwatch.ElapsedMilliseconds;
                DateTime CurrRecvTime = CaninitialDateTime.AddMilliseconds(currentTimestamp - CaninitialTimestamp);
                int RecvFrames = 0;
                try
                {
                    ...
                    double CanFrameSpan = CurrRecvTime.Subtract(CanLastRecv).TotalMilliseconds / (double)RecvFrames;
        ...
        //        auto_canfd.interval = 1000;     //周期单位，ms
        ...
        //        short InitForce = (short)(ClsGlobal.ClampForce / 1024);
        ...
        //        for (int i = 0; i < 11; i++)      //逐步增加   间隔10毫秒持续100毫秒
        //        {
        //            short clampForce =(short)(InitForce*Math.Pow(2.0,(double)i));
        //            if(clampForce>ClsGlobal.ClampForce)
        //            {
        //                clampForce = ClsGlobal.ClampForce;
        //            }

        //         //   SafeLogError(clampForce.ToString());
        ...
        //          //  SafeLogError(ClsGlobal.ClampForce.ToString());
        ...
        //                setPoint_speed = (short)ClsGlobal.ClampSpeed,
        //                setPoint_position = (short)ClsGlobal.ClampPosition,
        //                setPoint_clampForce = (short)(ClsGlobal.ClampForce / ClsGlobal.SendForceScale),
        //                operationMod_Req = (byte)ClsGlobal.ClampModReq,
        //                normalMode = (byte)ClsGlobal.ClampNormalMode,
        //                epbClampForceReq = (ushort)ClsGlobal.ClampForceReq,
        //                enable = (byte)ClsGlobal.ClampEnable
        ...
        private void GenerateClampCommand()
        {
            ...
            try
            {
                ...
                short DeltForce = (short)(ClsGlobal.ClampForce / 11) ;
        ...
        private void GenerateReleaseCommand()
        {
            ...
            try
            {
                ...
                short InitForce = ClsGlobal.ClampForce;
                ...
                for (int i = 0; i < 11; i++)      //逐步增加   间隔10毫秒持续100毫秒
                {
                    ...
                    //  SafeLogError(ClsGlobal.ReleaseForce.ToString());
        ...
        private void MakeCurveMapping()
        {
            ...
            curveDictionary.TryAdd("DAQ_Current", new LineItemOperation
            {
            ...
            curveDictionary.TryAdd("Act_Current", new LineItemOperation
            {
        ...
        public void UpdateGraphDisplay(DateTime dispTime, List<byte[]> CanData, double[] DaqCurrentData, double[] DaqTorqueData)
        {
            ...
            try
            {
                ...
                foreach (var item in curveDictionary)
                {
                    ...
                    if (item.Key == "DAQ_Current")
                    {
                        zedGraphRealChart.GraphPane.Y2Axis.IsVisible = item.Value.IsActive;
                    }
                    if (item.Key == "DAQ_Torque")
                    {
                        zedGraphRealChart.GraphPane.YAxisList[1].IsVisible = item.Value.IsActive;
                    }
                    if (item.Key == "Act_Current")
                    {
        ...
        private void InitializeEmbControlTimersAfterPause(uint TimeInterval,int Counter)
        {
            try
            {
                // EmbControlTimers = new List<TimerState>(1);
                ...
                for (int i = 0; i < 1; i++)
                {
                    ...
                    EmbControlTimers[i].CycleCounter[i] = Counter;
            ...
            try
            {
                ...
                if (!IsAutoLearn)
                {
                    ...
                    Func<System.Threading.Tasks.Task> asyncAction = async () =>
                    {
                        ...
                        {
                            short DeltForce = (short)(ClsGlobal.ClampForce / ClsGlobal.ClampCount);
                            short InitForce = DeltForce;

                            for (int i = 0; i < ClsGlobal.ClampCount; i++)
                            {
                                short clampForce = (short)(InitForce + DeltForce * i);
                                clampForce = clampForce > (short)ClsGlobal.ClampForce ? (short)ClsGlobal.ClampForce : clampForce;
                            ...
                            double PushDelt = ClsGlobal.ClampAoVol / (double)ClsGlobal.PushCount;
                            ...
                            for (int i = 0; i < ClsGlobal.PushCount; i++)
                            {
                                ...
                                AdjustPressure(ClsGlobal.ClampAoVol - PushDelt * (double)(i + 1));
                                await System.Threading.Tasks.Task.Delay(ClsGlobal.PushSpan);
                                //  System.Threading.Thread.Sleep(ClsGlobal.PushSpan);
                            }
                        ...
                        {
                            short InitForce = (short)(ClsGlobal.ClampForce / Math.Pow(2.0, (double)(ClsGlobal.ClampCount - 1)) + 1.0);
                            ...
                            double InitPush = ClsGlobal.ClampAoVol / Math.Pow(2.0, (double)(ClsGlobal.PushCount - 1));
                            for (int i = 0; i < ClsGlobal.PushCount; i++)
                            {
                                double currentPush = InitPush * Math.Pow(2.0, (double)i);

                                currentPush = currentPush > ClsGlobal.ClampAoVol ? ClsGlobal.ClampAoVol : currentPush;
                            ...
                            for (int i = 0; i < ClsGlobal.PushCount; i++)
                            {
                                ...
                                double currentPush = ClsGlobal.ClampAoVol / Math.Pow(2.0, (double)(i + 1));
                        ...
                        if (ClsGlobal.IsLiner > 0)
                        {
                            ...
                            double deltForce = ClsGlobal.ClampForce / (double)ClsGlobal.ReleaseCount;

                            for (int i = 0; i < ClsGlobal.ReleaseCount; i++)
                            {
                                short clampForce = (short)(ClsGlobal.ClampForce - (double)(i + 1) * deltForce);
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i < ClsGlobal.ReleaseCount; i++)
                            {
                                short clampForce = (short)(ClsGlobal.ClampForce / Math.Pow(2.0, (double)(i + 1)));
                                if (clampForce < 1000)
                                {
                                    clampForce = 0;
                                }
        ...
        private void DisplayCallback(object state)
        {
            try
            {
                ...
                lock (bufferLock)
                {
                    ...
                    dispTime = DispinitialDateTime.AddMilliseconds(currentTimestamp - DispinitialTimestamp);
                ...
                if (Monitor.TryEnter(graphLock, 1000))
                {
                    try
                    {
                        ...
                        UpdateDataGridView(forceSnapshot, daqCurrentSnapshot, daqTorqueSnapshot);
                    }
                    finally
                    {
        ...
        {
            DaqContext1 = new DaqAIContext("Dev1", 100, ClsGlobal.FileChangeMinutes, DaqTimeSpanMilSeconds, Dev1UsedDaqAIChannels.Length, ClsGlobal.SamplesPerChannel, DataStorePath);
        ...
        private async void BtnStartTest_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Canstopwatch = new Stopwatch();

                if (!Canstopwatch.IsRunning)
                {
                    CaninitialDateTime = DateTime.Now;
                    Canstopwatch.Start();
                    CaninitialTimestamp = Canstopwatch.ElapsedMilliseconds; // 记录启动时的时间戳
                }

                CanLastRecv = DateTime.Now;
                ...
                CurrentStatFileName = $"{DataStorePath}\\StatData.bin";
                ...
                InitCanRawLogTimer(dataLogSpan);
                InitDaqLogTimer(dataLogSpan);
                StatLog.Clear();
                StartWriteStatTimer((int)(testConfig.TestSpan * 10000.0));         //10个周期记录一次
                ...
                DeviceReset(ClsGlobal.DevResetWaitSpan,ClsGlobal.ReleaseAoVol);
        ...
        private int JudgeSinglePower()
        {
            for (int i = 0; i < 1; i++)
            {
                if (EmbGroup[i].IsEnabel && ClsGlobal.PowerStatus[0]<2)
                {
                    return i + 1;
                }
            }
        ...
        private void FrmMainMonitor_FormClosing(object sender, FormClosingEventArgs e)
        {
           if(IsRunning)
            ...
            if (IsAutoLearn)
            {
                ...
                MessageBox.Show("自学习正在进行中！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                e.Cancel = true;
                return;
            }
            ...
            if (IsPause)
            {
                MessageBox.Show("试验暂停中！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                e.Cancel = true;
                return;
            }
        ...
        private void BtnApply_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string SaveMsg=TestConfigOperation.SaveTestConfigToFile(xmlPath,testConfig);
        ...
        private void BtnStop_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _logtimers[0].Change(Timeout.Infinite, Timeout.Infinite);
                _logtimers[0].Dispose();
                ...
                if (Dev1runningAnalogTask != null && Dev1runningAnalogTask == ar.AsyncState)
                {
                    ...
                    if (IsRunning)
                    {
                       ...
                       // SafeLogError(DaqAiCurrentDispData.Count.ToString());
                        ...
                        DaqContext1.EnqueueData(data, DaqCurrentTime, DaqLastTime);
            ...
            try      //自学习状态
            {
                ...
                for (int i = 0; i < 1; i++)
                {
                    if (EmbGroup[i].IsEnabel)
                    {
                        ...
                        RtbInfo.Invoke(new SetTextCallback(SetInfoText), DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff  > ") + "EMB" + i.ToString() + " 清空CAN定时指令!");
        ...
        private async void AutoLearnStart()
        {
            try
            {
        ...
        public void UpdateDataGridView(List<byte[]> CanData, double[] DaqCurrentData, double[] DaqTorqueData)
        {
            ...
            {
                dgvRealData.Invoke(new Action<List<byte[]>, double[], double[]>(UpdateDataGridView), CanData, DaqCurrentData, DaqTorqueData);
                return;
            }
            ...
            try
            {
                ...
                UpdateDataRow("Act_Force", maxForce, minForce);
                UpdateDataRow("Act_Current", maxCurrent, minCurrent);
                ...
                byte[] buffer = new byte[StatLogRecordLens];

                int offset = 0;
                var BrakeNoBytes = BitConverter.GetBytes(BrakeNo - 1);
                Buffer.BlockCopy(BrakeNoBytes, 0, buffer, offset, 4);
                offset += 4;

                
                var timeBytes = BitConverter.GetBytes(DateTime.Now.AddSeconds(testConfig.TestSpan * -1.0).ToFileTime());
                Buffer.BlockCopy(timeBytes, 0, buffer, offset, 8);
                offset += 8;

                var MaxForceBytes = BitConverter.GetBytes(maxForce);
                Buffer.BlockCopy(MaxForceBytes, 0, buffer, offset, 8);
                offset += 8;

                var MaxCurrentBytes = BitConverter.GetBytes(maxCurrent);
                Buffer.BlockCopy(MaxCurrentBytes, 0, buffer, offset, 8);
                offset += 8;

                var MaxTorqueBytes = BitConverter.GetBytes(maxTorqueDaq);
                Buffer.BlockCopy(MaxTorqueBytes, 0, buffer, offset, 8);
                offset += 8;

                var MaxDaqCurrentBytes = BitConverter.GetBytes(maxCurrentDaq);
                Buffer.BlockCopy(MaxDaqCurrentBytes, 0, buffer, offset, 8);
                offset += 8;



                var MinForceBytes = BitConverter.GetBytes(minForce);
                Buffer.BlockCopy(MinForceBytes, 0, buffer, offset, 8);
                offset += 8;

                var MinCurrentBytes = BitConverter.GetBytes(minCurrent);
                Buffer.BlockCopy(MinCurrentBytes, 0, buffer, offset, 8);
                offset += 8;

                var MinTorqueBytes = BitConverter.GetBytes(minTorqueDaq);
                Buffer.BlockCopy(MinTorqueBytes, 0, buffer, offset, 8);
                offset += 8;

                var MinDaqCurrentBytes = BitConverter.GetBytes(minCurrentDaq);
                Buffer.BlockCopy(MinDaqCurrentBytes, 0, buffer, offset, 8);
                offset += 8;

                buffer[StatLogRecordLens - 1] = FaultMode;

                AddToStatLogCache(StatLogMaxLens, buffer, ref StatLog);
            }
        ...
        private async void AlertProc(int HandlerIndex)
        {
            try
            {
                ...
                System.Threading.Thread.Sleep(300);                //清空指令
                RtbInfo.Invoke(new SetTextCallback(SetInfoText), DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff  > ") + "EMB" + (HandlerIndex+1).ToString() + " 告警处置CAN 卡指令清零!");
            ...
            setAxisRangeItem.Click += (sender, e) =>
            {
...

                {
                    ...
                    if (dialog.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        listDaqCurrent.RemoveAll(p => p.X > (currentXMin + dialog.XMax));
                        listDaqTorque.RemoveAll(p => p.X > (currentXMin + dialog.XMax));

                        listForce.RemoveAll(p => p.X > (currentXMin + dialog.XMax));
                        listCanCurrent.RemoveAll(p => p.X > (currentXMin + dialog.XMax));


                        listDaqCurrent.RemoveAll(p => p.X < currentXMin);
                        listDaqTorque.RemoveAll(p => p.X < currentXMin);

                        listForce.RemoveAll(p => p.X < currentXMin);
                        listCanCurrent.RemoveAll(p => p.X < currentXMin);
        ...
        private async void DeviceReset(int LongWaitTime,double AdjustVol)   //回到起点
        {
           try
            {
        ...
        private  void MinitorEvent(object state)
        {
            try
            {
        ...
        private async System.Threading.Tasks.Task PushGoAndClamp()
        {
            try
            {
                ...
                if (ClsGlobal.IsLiner > 0)
                {
                    ...
                    short DeltForce = (short)(ClsGlobal.ClampForce / ClsGlobal.PushCount);
                    short InitForce = DeltForce;
                ...
                {
                    short InitForce = (short)(ClsGlobal.ClampForce / Math.Pow(2.0, (double)(ClsGlobal.PushCount - 1)) + 1.0);
        ...
        private async void BtnPause_Click(object sender, EventArgs e)
        {
            ...
            if(PauseCounter%2==1)
            {
                ...
                BtnPause.Text = "恢复运行";
                BtnPause.FillColor = Color.IndianRed;
                BtnPause.RectColor = Color.IndianRed;
                BtnPause.FillHoverColor = Color.Red;
                Application.DoEvents();
                TestPause();

                MessageBox.Show("试验暂停！若后续拆装操作，请关闭电源！", "安全提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            else
            {
                ...
                BtnPause.Text = "暂停";
                BtnPause.RectColor = Color.FromArgb(80, 160, 255);
                BtnPause.FillColor = Color.FromArgb(80, 160, 255);
                BtnPause.FillHoverColor = Color.FromArgb(115, 179, 255);
                Application.DoEvents();
                TestRecover();
            }
        }
        ...
        private async void TestRecover()
        {
            try
            {
                ...
                BrakeNo = int.Parse(LedRunCycles.Text) + 1;
               // StatLog.Clear();
                ...
                timerProgressDisp.Enabled = true;
                curveDisplayTimer = new System.Threading.Timer(DisplayCallback, null, curveDispSpan, curveDispSpan);
                InitializeEmbControlTimersAfterPause((uint)(testConfig.TestSpan * 1000.0), int.Parse(LedRunCycles.Text)+1);

                DaqLogtimer1.Change(dataLogSpan, dataLogSpan);
                //   DaqLogtimer1.Dispose();
                _logtimers[0].Change(dataLogSpan, dataLogSpan);
                ...
                StatLog.Clear();
                // StartWriteStatTimer((int)(testConfig.TestSpan * 10000.0));         //10个周期记录一次
                WriteStatTimer.Change((int)(testConfig.TestSpan * 10000.0), (int)(testConfig.TestSpan * 10000.0));
                ...
                RtbInfo.Invoke(new SetTextCallback(SetInfoText), DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff  > ") + "试验恢复!");
        ...
        private void TestPause()
        {
            try
            {
                ...
                WriteStatTimer.Change(Timeout.Infinite, Timeout.Infinite);
             ...
             //   _logtimers[0].Dispose();
                ...
                RtbInfo.Invoke(new SetTextCallback(SetInfoText), DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff  > ") + "试验暂停!");
            ...
            {
                MessageBox.Show("试图暂停试验失败! " + ex.Message, "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                BtnCancel.Enabled = false;
                BtnSettingDetail.Enabled = false;
                IsRunning = true;
            }
