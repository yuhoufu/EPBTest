...
namespace Controller
{
    ...
    public sealed class EpbManager
    {
        ...
        private readonly Func<int, double> _readPressure; // 与最新 HydraulicController 对齐
                          ...
                          IAppLogger log = null)
        {
            ...
            // 与最新 HydraulicController 构造函数签名对齐：
            // HydraulicController(DoController, TestConfig, Func<int,double>, AoController, IAppLogger)
            _hydraulic = new HydraulicController(_do, _cfg.Test, _readPressure, _ao, _log);
        }
