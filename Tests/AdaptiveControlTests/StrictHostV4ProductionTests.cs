...
namespace AdaptiveControlTests
{
    ...
    internal static class StrictHostV4ProductionTests
    {
        ...
        {
            var passed = 0;
            Run("V2.13.0.39 release assembly identity", WatchdogAssemblyVersionIdentity, ref passed);
