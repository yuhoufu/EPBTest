...
namespace AdaptiveControlTests
{
    ...
    internal static class StrictHostV4ProductionTests
    {
        ...
        {
            var passed = 0;
            Run("V2.13.0.23 watchdog assembly identity", WatchdogAssemblyVersionIdentity, ref passed);
