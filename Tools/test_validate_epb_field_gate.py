...
class FieldGateValidatorTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        (log / "run.log").write_text(
            "2026-08-08 10:00:00.000\tINFO\t启动\tProductVersion=V2.12.0.20\n"
            f"2026-08-08 10:00:00.000\tINFO\tFIELD\tFieldMetric SESSION Phase=Start RunId=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa Channels=4,9 Closed=False Detail=BatchFormal ProductVersion=V2.12.0.20 AssemblyVersion=2.12.0.20 ProcessId=1234 ExecutablePath=D:\\EPBTest\\MTTFTest.exe ExeSha256={sha} ConfigSha256={sha} GitCommit={commit} GitDirty=False BuildUtc=2026-08-08T00:00:00Z\n"
            ...
            "2026-08-08 11:00:00.000\tINFO\tFIELD\tFieldMetric SESSION Phase=Stop RunId=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa Channels=4,9 Closed=True Detail=ManualUi ProductVersion=V2.12.0.20 ExeSha256=unused ConfigSha256=unused GitCommit=unused GitDirty=False BuildUtc=unused\n"
    ...
    def test_second_unsealed_run_inside_older_window_blocks_fallback(self) -> None:
        ...
        second = (
            ...
            "Detail=BatchFormal ProductVersion=V2.12.0.20 ExeSha256=" + "a" * 64 +
    ...
    def test_duplicate_terminal_for_same_run_is_redline(self) -> None:
        ...
        duplicate = (
            ...
            "Detail=Duplicate ProductVersion=V2.12.0.20 ExeSha256=unused "
