...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Package\Deployment\Install-MTTFTest-Unattended.ps1" -Mode Install -SourceDirectory "%~dp0Package" -InstallRoot "%ProgramFiles%\MTTFTest"
if errorlevel 1 goto :failed
echo.
