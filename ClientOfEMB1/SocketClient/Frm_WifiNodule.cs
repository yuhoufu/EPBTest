...
namespace SocketClient
{
    ...
    0x02, 0x51, 0x4F, 0xF8, 0x02, 0x58, 0x2C, 0x1C, 
    0x9C,  0x51, 0x4F, 0xF8, 0x02, 0x58, 0x2C, 0x1C, 
    0x9C, 0x51, 0x4F, 0xF8, 0x02, 0x58, 0x2C, 0x1C, 
    0x9C, 0x51, 0x4F, 0xF8, 0x02, 0x58, 0x2C, 0x1C, 
    0x9C, 0x51, 0x4F, 0xF8, 0x02, 0x58, 0x2C, 0x1C, 
    0x9C, 0x51, 0x4F, 0xF8, 0x02, 0x58, 0x2C, 0x1C, 
    0x9C, 0x51, 0x4F, 0xF8, 0x02, 0x58, 0x2C, 0x1C 
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
          ...
          //      byte[] byteSend = (byte[])OriginalByteSend.Clone();
                byte[] byteSend = (byte[])OriginalByteSend.Clone();
                byteSend[2] = valueBytes[1]; // 第3个字节（索引2）
                byteSend[3] = valueBytes[0]; // 第4个字节（索引3）


                byteSend[4] = (byte)(valueBytes[1] - 0x02);
                byteSend[5] = (byte)(valueBytes[0] - 0x02);
